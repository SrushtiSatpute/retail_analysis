...
-- Insert data into Customer table from table Temp_Retail
...
-- Add column Country_ID in Address table without not null

ALTER TABLE ADDRESS 
ADD COLUMN Country_ID INT;

-- Inserting data in Country_ID column in address table(query time = 2.657 sec)
...
INSERT INTO Transaction(Transaction_ID ,Customer_ID,Date,Year,Month,Time,Total_Purchases,Total_Amount)            -- 45532 rows returned without duplicates
