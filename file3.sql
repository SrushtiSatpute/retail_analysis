...
SELECT COUNT(*) FROM Temp_Retail WHERE Date IS NULL LIMIT 50000;               -- date format = '0000-00-00'

-- Checking for duplicate transaction entry which prevents data insertion and deleting duplicate records
